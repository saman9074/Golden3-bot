...
local function run(msg, matches)
    if permissions(msg.from.id, msg.to.id, "lang_install") then
        ...
        set_text(LANG, 'noSwearingT', 'در این گروه شما نمیتوانید از الفاظ رکیک استفاده کنید.')
        set_text(LANG, 'noSwearingL', 'در این سوپر گروه شما نمیتوانید از الفاظ رکیک استفاده کنید.')
        set_text(LANG, 'SwearingT', 'از این به بعد استفاده از الفاظ رکیک در این گروه آزاد است.')
        set_text(LANG, 'SwearingL', 'از این به بعد استفاده از الفاظ رکیک در این سوپر گروه آزاد است.')
    ...
    set_text(LANG, 'muteAll', 'توانایی صحبت از همه گرفته شد.')
        ...
        set_text(LANG, 'settings:3', '#settings english enable/disabl : وقتی فعال باشد ، ربات  تمامی پیام های انگلیسی را پاک خواهد کرد')
        set_text(LANG, 'settings:3', '#settings bdw enable/disabl : وقتی فعال باشد ، ربات  تمامی پیام های حاوی الفاظ رکیک را پاک خواهد کرد')
